...
This repository is in active bootstrap. Version `0.7.0` adds host-safe file browsing and light editing, changed-file surfaces in the web shell, and a review start flow that stays behind the host gateway.
